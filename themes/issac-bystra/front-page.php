    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <section class="issac-front-hero container-fluid px-5 px-md-0 bg-brand-accent">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <p class="issac-front-hero__tag"><?php esc_html_e('Inclusive Education · Professional Learning', 'bystra'); ?></p>
                        <h1 class="issac-front-hero__title headline-1">Inclusive Schools Self-Assessment Checklist (ISSAC)</h1>
                        ...
                        <?php if ($hero_stats !== []) : ?>
                        <div class="issac-front-hero__stats mb-5" aria-label="<?php esc_attr_e('Instrument overview', 'bystra'); ?>">
